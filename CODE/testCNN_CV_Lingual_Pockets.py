# Pocket detection for Lingual side with CNN using a sliding window of size w
#
########################################################################################################################
...
classNamesLingual = ['no pocket', 'pocket']
########################################################################################################################
# import the data:
########################################################################################################################
...
labelsLingual = [yLingual1, yLingual2, yLingual3, yLingual4,
                 yLingual5, yLingual6, yLingual7, yLingual8,
...
# SAVE
########################################################################################################################
reports_12_fn = ('RESULTS/reportsCNN_Lingual_w_' + str(w) + '_pockets.p')
with open(reports_12_fn, 'wb') as fp:
    pickle.dump(reportsLingual, fp)

confusionMatrices_12_fn = ('RESULTS/confusionMatricesCNN_Lingual_w_' + str(w) + '_pockets.p')
with open(confusionMatrices_12_fn, 'wb') as fp:
    pickle.dump(confusionMatricesLingual, fp)

normConfusionMatrices_12_fn = ('RESULTS/normConfusionMatricesCNN_Lingual_w_' + str(w) + '_pockets.p')
with open(normConfusionMatrices_12_fn, 'wb') as fp:
    pickle.dump(normConfusionMatrices, fp)

predictedLabels_12_fn = ('RESULTS/predLabelsCNN_Lingual_w_' + str(w) + '_pockets.p')
with open(predictedLabels_12_fn, 'wb') as fp:
    pickle.dump(yhatPerFold, fp)

actualLabels_12_fn = ('RESULTS/actualLabelsCNN_Lingual_w_' + str(w) + '_pockets.p')
with open(actualLabels_12_fn, 'wb') as fp:
    pickle.dump(ytsPerFold, fp)

valLoss_12_fn = ('RESULTS/valLossCNN_Lingual_w_' + str(w) + '_pockets.p')
with open(valLoss_12_fn, 'wb') as fp:
    pickle.dump(valLossPerFold, fp)

valAccuracy_12_fn = ('RESULTS/valAccuracyCNN_Lingual_w_' + str(w) + '_pockets.p')
with open(valAccuracy_12_fn, 'wb') as fp:
    pickle.dump(valAccuracyPerFold, fp)

trainLoss_12_fn = ('RESULTS/trainLossCNN_Lingual_w_' + str(w) + '_pockets.p')
with open(trainLoss_12_fn, 'wb') as fp:
    pickle.dump(trainLossPerFold, fp)

trainAccuracy_12_fn = ('RESULTS/trainAccuracyCNN_Lingual_w_' + str(w) + '_pockets.p')
with open(trainAccuracy_12_fn, 'wb') as fp:
    pickle.dump(trainAccuracyPerFold, fp)

testAccuracy_12_fn = ('RESULTS/testAccuracyCNN_Lingual_w_' + str(w) + '_pockets.p')
...
plt.tight_layout()
plt.savefig(
    'FIGURES/normCM_CNN_LINGUAL_six_regions_manual_' + str(numFeatures) + '_features_w_' + str(w) + '_pockets.pdf')
...
classes = list(reportsLingual[0].keys())[0:numClasses]
