# Probed region detection for Buccal side with LSTN
...
# selectedFeatures = [0, 1, 17, 19]#, 20, 2,23,16,15,22] # this set of features with w = 8 gives best results for buccal 0.92%
...
trainAccuracy_12_fn = ('RESULTS/trainAccuracyLSTM_Buccal_w.p')
with open(trainAccuracy_12_fn, 'wb') as fp:
    pickle.dump(trainAccuracyPerFold, fp)

testAccuracy_12_fn = ('RESULTS/testAccuracyLSTM_Buccal_w.p')
...
plt.tight_layout()
plt.savefig('FIGURES/normCM_LSTM_BUCCAL_six_regions_manual_' + str(numFeatures) + '_features_w.pdf')
