# Pocket detection with  LSTM for Lingual side
...
labelsLingual = [yLingual1, yLingual2, yLingual3, yLingual4, yLingual5, yLingual6, yLingual7, yLingual8, yLingual9,
                 yLingual10, yLingual11, yLingual12]
...
normConfusionMatrices_12_fn = ('RESULTS/normConfusionMatricesLSTM_Lingual_w_pockets.p')
with open(normConfusionMatrices_12_fn, 'wb') as fp:
    pickle.dump(normConfusionMatrices, fp)

predictedLabels_12_fn = ('RESULTS/predLabelsLSTM_Lingual_w_pockets.p')
with open(predictedLabels_12_fn, 'wb') as fp:
    pickle.dump(yhatPerFold, fp)

actualLabels_12_fn = ('RESULTS/actualLabelsLSTM_Lingual_w_pockets.p')
with open(actualLabels_12_fn, 'wb') as fp:
    pickle.dump(ytsPerFold, fp)

valLoss_12_fn = ('RESULTS/valLossLSTM_Lingual_w_pockets.p')
with open(valLoss_12_fn, 'wb') as fp:
    pickle.dump(valLossPerFold, fp)

valAccuracy_12_fn = ('RESULTS/valAccuracyLSTM_Lingual_w_pockets.p')
with open(valAccuracy_12_fn, 'wb') as fp:
    pickle.dump(valAccuracyPerFold, fp)

trainLoss_12_fn = ('RESULTS/trainLossLSTM_Lingual_w_pockets.p')
...
trainAccuracy_12_fn = ('RESULTS/trainAccuracyLSTM_Lingual_w_pockets.p')
with open(trainAccuracy_12_fn, 'wb') as fp:
    pickle.dump(trainAccuracyPerFold, fp)

testAccuracy_12_fn = ('RESULTS/testAccuracyLSTM_Lingual_w_pockets.p')
