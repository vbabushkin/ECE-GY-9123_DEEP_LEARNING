# Generating the confusion matrices and barplots for report for LSTM
########################################################################################################################
...
fig.tight_layout()
plt.savefig('FIGURES/LSTM_metrics_12fold_barplot_paper_' + str(numFeatures) + '_features_w.pdf')

########################################################################################################################

# Then we can load seaborn to plot confusion matrices. Otherwise it will make background for matplotlib plots grey
